...
export default function OrderCard({ cart }: OrderCardProps) {
  return (
    <>
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-semibold">Commande : {cart.id}</h3>
        <div className="text-sm font-semibold text-gray-200 bg-purple-800 rounded-2xl px-2 py-1">
          User Id:{cart.userId}
        </div>
      </div>
